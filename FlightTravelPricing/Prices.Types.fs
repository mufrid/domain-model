...
type Price = { Amount : PriceAmount; Currency : PriceCurrency }

type MembershipType = Gold | Regular | NotAMember
type CustomerAge = CustomerAge of uint
type Customer = { MembershipType : MembershipType; Age : CustomerAge }
...
type DiscountValidityPeriod = { StartTime : System.DateTime; EndTime : System.DateTime }
type Discount = { Percentage : uint; Validity : DiscountValidityPeriod }
